...
function editBarang(index){
    ...
    let namaBaru =
    prompt('Edit Nama Barang', item.nama);

    let hargaBaru =
    prompt('Edit Harga Barang', item.harga);

    let stokBaru =
    prompt('Edit Stok Barang', item.stok);
...
function tambahTransaksi(){
    ...
    let jumlah =
Number(document.getElementById('jumlahBarang').value);
...
.innerText = totalSemuaTransaksi + transaksi.length;
